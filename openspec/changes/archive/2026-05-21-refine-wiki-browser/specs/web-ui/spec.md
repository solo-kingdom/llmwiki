...
**Reason**: Primary Wiki search is implemented via `wiki-search-modal` in the reader header, not a sidebar dropdown.
**Migration**: Use Cmd/Ctrl+K search modal with type filters per `wiki-search-modal` capability.
