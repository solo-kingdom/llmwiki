# wiki-page-templates Specification

## Purpose
Define wiki page template scaffold creation on workspace init and generation prompt template guidance for the ingest pipeline.
