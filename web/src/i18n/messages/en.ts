...
const en: Record<MessageKey, string> = {
  ...
  "chat.archive_review_hint": "Archive submitted — open Review to inspect the plan",
  "chat.archive_review_ready": "Archive review created — approve the plan before wiki files are written",
  "chat.go_to_review": "Go to Review",
